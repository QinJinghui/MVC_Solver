...
for epoch in range(n_epochs):
    ...
    if epoch % 1 == 0 or epoch > n_epochs - 5:
        ...
        for test_batch in test_pairs:
            ...
            test_res, test_res_v1 = evaluate_mvlm2tree(tokens_dict["input_ids"], len(tokens_dict["input_ids"]), tokens_dict["attention_mask"], tokens_dict["token_type_ids"], generate_num_ids, encoder, predict, generate,
