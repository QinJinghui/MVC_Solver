...
copy_nums = None
group_data = None
if dataset_name == "Math23K" or dataset_name == "Math23K_char":
...
for fold in range(fold_num):
    ...
    for epoch in range(n_epochs):
        ...
        batch_dict = prepare_data_batch(train_pairs, batch_size, use_group_num=True, use_lm=False)
        ...
        graph_batches = batch_dict['num_graph_batches']
        ...
        if epoch % 1 == 0 or epoch > n_epochs - 5:
            ...
            for test_batch in test_pairs:
                batch_graph = get_single_example_graph(test_batch['input_cell'], test_batch['input_cell_len'],
                                                       ...
                                                       test_batch['num_pos'])
                test_res, test_res_v1 = evaluate_mv_graph2tree(test_batch['input_cell'], test_batch['input_cell_len'],
                                               generate_num_ids, encoder, predict, generate, merge, output_lang,
                                               test_batch['num_pos'], batch_graph, beam_size=beam_size,
            ...
            torch.save(encoder.state_dict(), os.path.join(current_save_dir, "graph2tree_encoder"))
            torch.save(predict.state_dict(), os.path.join(current_save_dir, "graph2tree_predict"))
            torch.save(generate.state_dict(), os.path.join(current_save_dir, "graph2tree_generate"))
            torch.save(merge.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge"))
            if not use_share_decoder:
                torch.save(predict_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_v1"))
                torch.save(generate_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_v1"))
                torch.save(merge_v1.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_v1"))

            if best_val_acc < value_ac:
                best_val_acc = value_ac
                current_best_val_acc = (equation_ac, value_ac, eval_total)
                torch.save(encoder.state_dict(), os.path.join(current_save_dir, "graph2tree_encoder_best_val_acc"))
                torch.save(predict.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_best_val_acc"))
                torch.save(generate.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_best_val_acc"))
                torch.save(merge.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_best_val_acc"))
                if not use_share_decoder:
                    torch.save(predict_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_v1_best_val_acc"))
                    torch.save(generate_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_v1_best_val_acc"))
                    torch.save(merge_v1.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_v1_best_val_acc"))

            # if best_equ_acc < equation_ac:
            #     best_equ_acc = equation_ac
            #     torch.save(encoder.state_dict(), os.path.join(current_save_dir, "graph2tree_encoder_best_equ_acc"))
            #     torch.save(predict.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_best_equ_acc"))
            #     torch.save(generate.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_best_equ_acc"))
            #     torch.save(merge.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_best_equ_acc"))
            #     if not use_share_decoder:
            #         torch.save(predict_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_v1_best_equ_acc"))
            #         torch.save(generate_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_v1_best_equ_acc"))
            #         torch.save(merge_v1.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_v1_best_equ_acc"))

            if best_val_acc_v1 < value_ac_v1:
                best_val_acc_v1 = value_ac_v1
                current_best_val_acc_v1 = (equation_ac_v1, value_ac_v1, eval_total)
                torch.save(encoder.state_dict(), os.path.join(current_save_dir, "graph2tree_encoder_best_val_acc_v1"))
                torch.save(predict.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_best_val_acc_v1"))
                torch.save(generate.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_best_val_acc_v1"))
                torch.save(merge.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_best_val_acc_v1"))
                if not use_share_decoder:
                    torch.save(predict_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_v1_best_val_acc_v1"))
                    torch.save(generate_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_v1_best_val_acc_v1"))
                    torch.save(merge_v1.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_v1_best_val_acc_v1"))

            # if best_equ_acc_v1 < equation_ac_v1:
            #     best_equ_acc_v1 = equation_ac_v1
            #     torch.save(encoder.state_dict(), os.path.join(current_save_dir, "graph2tree_encoder_best_equ_acc_v1"))
            #     torch.save(predict.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_best_equ_acc_v1"))
            #     torch.save(generate.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_best_equ_acc_v1"))
            #     torch.save(merge.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_best_equ_acc_v1"))
            #     if not use_share_decoder:
            #         torch.save(predict_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_predict_v1_best_equ_acc_v1"))
            #         torch.save(generate_v1.state_dict(), os.path.join(current_save_dir, "graph2tree_generate_v1_best_equ_acc_v1"))
            #         torch.save(merge_v1.state_dict(),  os.path.join(current_save_dir, "graph2tree_merge_v1_best_equ_acc_v1"))
