...
if dataset_name == "Math23K":
    ckpt_dir = "Math23K_s2t_val_test"
    data_dir = "./dataset/math23k/"
    data_path = data_dir + "Math_23K.json"
    prefix = '23k_processed.json'
elif dataset_name == "Math23K_char":
    ckpt_dir = "Math23K_char_s2t_val_test"
    data_dir = "./dataset/math23k/"
    data_path = data_dir + "Math_23K_char.json"
    prefix = '23k_processed.json'
elif dataset_name == "cm17k":
    var_nums = ['x', 'y']
    ckpt_dir = "cm17k_s2t_val_test"
...
# Initialize models
encoder = S2TEncoderSeq(input_size=input_lang.n_words, embedding_size=embedding_size, hidden_size=hidden_size,
...
for epoch in range(n_epochs):
    ...
    for idx in range(len(input_lengths)):
        ...
        for step in range(grad_acc_steps):
            ...
            loss = train_seq2tree(input_batches[idx][start_idx:end_idx],
    ...
    if epoch % 1 == 0 or epoch > n_epochs - 5:
        ...
        for test_batch in test_pairs:
            test_res = evaluate_seq2tree(test_batch['input_cell'], test_batch['input_cell_len'],
                                         generate_num_ids, encoder, predict, generate, merge,
