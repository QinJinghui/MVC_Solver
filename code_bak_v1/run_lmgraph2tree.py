...
for fold in range(fold_num):
    ...
    # Initialize models
    encoder = PLMGraphEncoderSeq(model_path=bert_path)
    ...
    encoder_graph_optimizer = AdamW(encoder.gcn.parameters(), lr=learning_rate, weight_decay=weight_decay)
    ...
    for epoch in range(n_epochs):
        ...
        batch_dict = prepare_data_batch(train_pairs, batch_size, lm_tokenizer=bert_tokenizer,
                                        use_lm=True, use_group_num=True)
        ...
        for idx in range(len(input_lengths)):
            ...
            for step in range(grad_acc_steps):
                ...
                loss = train_lmgraph2tree(input_batches[idx][start_idx:end_idx],
                                          ...
                                          encoder_bert_optimizer, encoder_graph_optimizer, predict_optimizer, generate_optimizer,
        ...
        if epoch % 1 == 0 or epoch > n_epochs - 5:
            ...
            for test_batch in test_pairs:
                ...
                test_res = evaluate_lmgraph2tree(tokens_dict["input_ids"], len(tokens_dict["input_ids"]),
                                                 tokens_dict["attention_mask"], tokens_dict["token_type_ids"],
                                                 generate_num_ids, encoder, predict, generate, merge,
                                                 output_lang, num_pos, batch_graph, beam_size=beam_size,
